/**
 * Mesh simplification using vertex clustering for tree collision meshes.
 * Deterministic algorithm that produces identical results on client and server.
 */

import type { TreeMesh, TreeColliderMesh } from './TreeMesh.js';

export class TreeMeshDecimator {
  /**
   * Simplify a tree mesh using vertex clustering.
   * 
   * Algorithm:
