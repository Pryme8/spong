...
export class BloodSplatterEffect extends BaseEffect {
  ...
  constructor(scene: Scene) {
    ...
    this.textures.push(this.colorTexture, this.maskTexture);
  ...
  /**
   * Generate textures (BloodSplatter creates them in constructor).
   */
  async generate(): Promise<void> {
    // Textures are created in constructor, mark as ready
    this.isReady = true;
  }
